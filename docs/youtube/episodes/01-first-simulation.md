...
### 0:30 - Install (1 min)
```bash
pip install https://github.com/Achref-Yak/DynaFX/releases/download/v0.4.0/dynafx-0.4.0-py3-none-any.whl
```
...
Install: pip install https://github.com/Achref-Yak/DynaFX/releases/download/v0.4.0/dynafx-0.4.0-py3-none-any.whl
