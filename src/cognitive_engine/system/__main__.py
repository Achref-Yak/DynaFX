...
Usage:
    python -m cognitive_engine.system simulate <file.sysd> [options]
    python -m cognitive_engine.system validate <file.sysd>
...
def main() -> None:
    ...
    sim.add_argument("--stats", action="store_true", default=False,
                     help="Print DES/ABM statistics after simulation")
    ...
    lst.add_argument("--dir", type=str, default=None, help="Scan custom directory")
