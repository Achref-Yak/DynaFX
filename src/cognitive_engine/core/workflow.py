...
class PrimitiveRegistry:
    ...
    def _discover_operators(self) -> None:
        op_modules = [
            "cognitive_engine.operators.abduce",
            "cognitive_engine.operators.align",
            "cognitive_engine.operators.analogy",
            "cognitive_engine.operators.attention",
            "cognitive_engine.operators.bottleneck",
            "cognitive_engine.operators.compare",
            ...
            "cognitive_engine.operators.merge",
            "cognitive_engine.operators.plan",
            "cognitive_engine.operators.propagate",
            "cognitive_engine.operators.relate",
            "cognitive_engine.operators.schema",
            "cognitive_engine.operators.simulate",
            "cognitive_engine.operators.stock_flow",
            "cognitive_engine.operators.systems",
            "cognitive_engine.operators.temporal",
            "cognitive_engine.operators.tom",
            "cognitive_engine.operators.update",
        ]
