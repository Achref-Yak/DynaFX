...
from dynafx.system._parser import (
    ExprNode,
    ExprLiteral,
    ExprRef,
    ExprBinOp,
...
class SysdModel:
    ...
    programmatically by populating the dataclass fields.
    """
    ...
    def simulate(
        ...
        if self.queues or self.resources or self.events:
            ...
            for q in self.queues:
                ...
                if q.service_time:
                    try:
                        from dynafx.system._parser import ExprParser, _compile_expr
        ...
        if des_engine:
            for q in self.queues:
                if q.arrival_rate:
                    try:
                        from dynafx.system._parser import ExprParser
